...
This project is my solution in **Windows Legacy (Deprecated), C#** to the **Calculating Loss Invoices** practice found in section 04 practice 02 of the UiPath - RPA Developer Foundation course.
...
**GitHub:** https://github.com/ShonHarsh/RPADev-S04P02-CalculatingLossInvoices-WindowsLegacy
...
`git clone https://github.com/ShonHarsh/RPADev-S04P02-CalculatingLossInvoices-WindowsLegacy`
